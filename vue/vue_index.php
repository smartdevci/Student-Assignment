            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-fw fa-user"></i> General Informations</h3>
                            </div>
                            <div class="panel-body">
                                <div class="list-group">
                                    <a href="" class="list-group-item">
                                        <span class="badge"><?php echo $number_consultation ?></span>
                                        <i class="fa fa-fw fa-user"></i> Number of consultation
                                    </a>
                                    <a href="" class="list-group-item">
                                        <span class="badge"><?php echo $number_consultation_having_assignment ?></span>
                                        <i class="fa fa-fw fa-user"></i> Number of consultation having assignment
                                    </a>
                                    <a href="" class="list-group-item">
